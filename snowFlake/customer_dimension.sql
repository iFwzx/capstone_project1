...
-- Merge statement to synchronize data from the raw CUSTOMER table into the INTERMEDIATE CUSTOMER_SNAPSHOT table
...
-- Creation of the CUSTOMER_DIM table in the ANALYTICS schema using data from several joined tables
        (select 
        C_SALUTATION,
        C_PREFERRED_CUST_FLAG,
        C_FIRST_SALES_DATE_SK,
